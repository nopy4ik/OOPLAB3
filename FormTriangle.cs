...
namespace OOPLAB3
{
    public partial class FormTriangle : Form
    {
        ...
        public FormTriangle(PictureBox pb, Bitmap bmp, Button btn, ComboBox box)
        {
            InitializeComponent();
            this.pb = pb;
            this.bmp = bmp;
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            if (i <= count)
            {
                try
                {
                    ...
                    if (i >= count)
                    {
                        labelXY.Text = $"Введите координаты 3-й точки: ";
        ...
        {
            Triangle triangle = new Triangle(pb, bmp, points);
            triangle.Draw(triangle.pen);
            box.Items.Add(triangle.Name);
