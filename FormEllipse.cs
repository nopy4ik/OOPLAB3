...
namespace OOPLAB3
{
    public partial class FormEllipse : Form
    {
        ...
        public FormEllipse(PictureBox pb, Bitmap bmp, Button btn, ComboBox box)
        {
            InitializeComponent();
            this.pb = pb;
            this.bmp = bmp;
        ...
        private void BDraw_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Ellipse ellipse = new Ellipse(x, y, w, h, pb, bmp);
                    ellipse.Draw(ellipse.pen);
                    box.Items.Add(ellipse.Name);
                }
            }
            catch (Exception ex)
            {
        ...
        private void FormEllipse_MouseDown(object sender, MouseEventArgs e)
        {
            base.Capture = false;
